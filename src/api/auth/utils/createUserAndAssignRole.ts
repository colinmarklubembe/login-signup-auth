      ...
      await resend.emails.send({
        ...
        html: `
          ...
          <div style="text-align: center;">
            <a href="http://localhost:4000/auth2/api_owner/verify?token=${token}" 
          ...
          <p>http://localhost:4000/auth2/api_owner/verify?token=${token}</p>
...
const reverifyUser = async (email: string, res: Response) => {
  try {
    ...
    try {
      ...
      <p>If the button above doesn't work, you can copy and paste the following link into your browser:</p>
      <p>http://localhost:4000/auth2/api_owner/user/verify?token=${token}</p>
      <p>Best regards,<br>The Team</p>
    `,
      });
      res.status(200).send({
